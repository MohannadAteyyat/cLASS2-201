...
function secondOne() {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        while (!birthYear) {
            alert('Please Enter a number'), birthYear = Number(prompt('What year I was porn?, writ only numbers'))
...
function therrdOne() {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        while (!myGrade) {
            alert('Please Enter a number'), myGrade = Number(prompt('what is my high school grade?, write only numbers'))
                , console.log('what is my high school grade?' + myGrade)
        }
...
function fourthOne() {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        while (!mycollege) {
            alert('Please Enter a number'), mycollege = Number(prompt('what is my college  grade?, write only numbers'))
                , console.log('what is my college  grade?' + mycollege)
        }
...
function fivethOne() {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        while (!gradYear) {
            alert('Please Enter a number'), gradYear = Number(prompt('what year I graduated from college?, write only numbers'))
                , console.log('what year I graduated from college?' + gradYear)
        }
    ...
    for (let i = 0; i < 3; i++) {
        ...
        while (!brothersNum) {
            alert('Please Enter a number'), brothersNum = Number(prompt('How many brothers I have, write only numbers'))
                , console.log('How many brothers I have' + brothersNum)
        }
...
for (let j = 0; j < 6; j++) {
    let qus1 = prompt('Who is my friend in class 201?', 'ahmad, mohammad, kaled, hasan, hanan, husam, suahib, ola, reem, ro\'a, leen,  rand, reham')
    console.log('Who is my friend in class 201?' + qus1)
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 === qus[i]) {
            alert('You answered correctly'), console.log('Who is my friend in class 201?' + qus1)
            j = 7
            score++
            break;
        }
    ...
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 !== qus[i]) {
            alert('You\'r gues is wrong , try again please'), console.log('Who is my friend in class 201?' + qus1)
            break;
        }
    }
}
...
for (let j = 0; j < 6; j++) {
    let qus1 = prompt('Who is younger than me in class 201?', 'ahmad, mohammad, kaled, hasan, hanan, husam, suahib, ola, reem, ro\'a, leen,  rand, reham')
    console.log('Who is younger than me in class 201?' + qus1)
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 === qus[i]) {
            alert('You answered correctly'), console.log('Who is younger than me in class 201?' + qus1)
            j = 7
            score++
            break;
        }
    ...
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 !== qus[i]) {
            alert('You\'r gues is wrong , try again please'), console.log('Who is younger than me in class 201?' + qus1)
            break;
        }
    }
}
...
for (let j = 0; j < 6; j++) {
    let qus1 = prompt('Who is taller than me in class 201?', 'ahmad, mohammad, kaled, hasan, hanan, husam, suahib, ola, reem, ro\'a, leen,  rand, reham')
    console.log('Who is taller than me in class 201?' + qus1)
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 === qus[i]) {
            alert('You answered correctly'), console.log('Who is taller than me in class 201?' + qus1)
            j = 7
            score++
            break;
        }
    ...
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 !== qus[i]) {
            alert('You\'r gues is wrong , try again please'), console.log('Who is taller than me in class 201?' + qus1)
            break;
        }
    }
}
...
for (let j = 0; j < 6; j++) {
    let qus1 = prompt('Who is shorter than me in class 201?', 'ahmad, mohammad, kaled, hasan, hanan, husam, suahib, ola, reem, ro\'a, leen,  rand, reham')
    console.log('Who is shorter than me in class 201?' + qus1)
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 === qus[i]) {
            alert('You answered correctly'), console.log('Who is shorter than me in class 201?' + qus1)
            j = 7
            score++
            break;
        }
    ...
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 !== qus[i]) {
            alert('You\'r gues is wrong , try again please'), console.log('Who is shorter than me in class 201?' + qus1)
            break;
        }
    }
}
...
for (let j = 0; j < 6; j++) {
    let qus1 = prompt('Who is older than me in class 201?', 'ahmad, mohammad, kaled, hasan, hanan, husam, suahib, ola, reem, ro\'a, leen,  rand, reham')
    console.log('Who is older than me in class 201?' + qus1)
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 === qus[i]) {
            alert('You answered correctly'), console.log('Who is older than me in class 201?' + qus1)
            j = 7
            score++
            break;
        }
    ...
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 !== qus[i]) {
            alert('You\'r gues is wrong , try again please'), console.log('Who is older than me in class 201?' + qus1)
            break;
        }
    }
}
...
for (let j = 0; j < 6; j++) {
    let qus1 = prompt('Who is smarter than me in class 201?', 'ahmad, mohammad, kaled, hasan, hanan, husam, suahib, ola, reem, ro\'a, leen,  rand, reham')
    console.log('Who is smarter than me in class 201?' + qus1)
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 === qus[i]) {
            alert('You answered correctly'), console.log('Who is smarter than me in class 201?' + qus1)
            j = 7
            score++
            break;
        }
    ...
    for (let i = 0; i <= qus.length; i++) {
        if (qus1 !== qus[i]) {
            alert('You\'r gues is wrong , try again please'), console.log('Who is smarter than me in class 201?' + qus1)
            break;
        }
    }
}
